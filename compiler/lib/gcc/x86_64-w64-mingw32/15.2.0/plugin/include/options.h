...
enum opt_code
{
  ...
  OPT_mno_default = 2189,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2190,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2191,                  /* -mno-push-args */
  OPT_mno_red_zone = 2192,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2193,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 2194,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 2195,                    /* -mnop-mcount */
  OPT_mnoreturn_no_callee_saved_registers = 2196,/* -mnoreturn-no-callee-saved-registers */
  OPT_momit_leaf_frame_pointer = 2197,       /* -momit-leaf-frame-pointer */
  OPT_mpartial_vector_fp_math = 2198,        /* -mpartial-vector-fp-math */
  OPT_mpc32 = 2199,                          /* -mpc32 */
  OPT_mpc64 = 2200,                          /* -mpc64 */
  OPT_mpc80 = 2201,                          /* -mpc80 */
  OPT_mpclmul = 2202,                        /* -mpclmul */
  OPT_mpcommit = 2203,                       /* -mpcommit */
  OPT_mpconfig = 2204,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 2205,            /* -mpe-aligned-commons */
  OPT_mpku = 2206,                           /* -mpku */
  OPT_mpopcnt = 2207,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2208, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2209,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2210,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2211,                     /* -mprefetchi */
  OPT_mprfchw = 2212,                        /* -mprfchw */
  OPT_mptwrite = 2213,                       /* -mptwrite */
  OPT_mpush_args = 2214,                     /* -mpush-args */
  OPT_mraoint = 2215,                        /* -mraoint */
  OPT_mrdpid = 2216,                         /* -mrdpid */
  OPT_mrdrnd = 2217,                         /* -mrdrnd */
  OPT_mrdseed = 2218,                        /* -mrdseed */
  OPT_mrecip = 2219,                         /* -mrecip */
  OPT_mrecip_ = 2220,                        /* -mrecip= */
  OPT_mrecord_mcount = 2221,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2222,                 /* -mrecord-return */
  OPT_mred_zone = 2223,                      /* -mred-zone */
  OPT_mregparm_ = 2224,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2225,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2226,                           /* -mrtd */
  OPT_mrtm = 2227,                           /* -mrtm */
  OPT_msahf = 2228,                          /* -msahf */
  /* OPT_mscatter = 2229, */                 /* -mscatter */
  OPT_mserialize = 2230,                     /* -mserialize */
  OPT_msgx = 2231,                           /* -msgx */
  OPT_msha = 2232,                           /* -msha */
  OPT_msha512 = 2233,                        /* -msha512 */
  OPT_mshstk = 2234,                         /* -mshstk */
  OPT_mskip_rax_setup = 2235,                /* -mskip-rax-setup */
  OPT_msm3 = 2236,                           /* -msm3 */
  OPT_msm4 = 2237,                           /* -msm4 */
  OPT_msoft_float = 2238,                    /* -msoft-float */
  OPT_msse = 2239,                           /* -msse */
  OPT_msse2 = 2240,                          /* -msse2 */
  OPT_msse2avx = 2241,                       /* -msse2avx */
  OPT_msse3 = 2242,                          /* -msse3 */
  OPT_msse4 = 2243,                          /* -msse4 */
  OPT_msse4_1 = 2244,                        /* -msse4.1 */
  OPT_msse4_2 = 2245,                        /* -msse4.2 */
  OPT_msse4a = 2246,                         /* -msse4a */
  /* OPT_msse5 = 2247, */                    /* -msse5 */
  OPT_msseregparm = 2248,                    /* -msseregparm */
  OPT_mssse3 = 2249,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2250,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2251, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2252,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2253, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2254,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2255,                  /* -mstackrealign */
  OPT_mstore_max_ = 2256,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2257,            /* -mstringop-strategy= */
  OPT_mstv = 2258,                           /* -mstv */
  OPT_mtbm = 2259,                           /* -mtbm */
  OPT_mthreads = 2260,                       /* -mthreads */
  OPT_mtls_dialect_ = 2261,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2262,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2263,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2264,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2265,                         /* -mtune= */
  OPT_muintr = 2266,                         /* -muintr */
  OPT_municode = 2267,                       /* -municode */
  OPT_munroll_only_small_loops = 2268,       /* -munroll-only-small-loops */
  OPT_muse_libstdc_wrappers = 2269,          /* -muse-libstdc-wrappers */
  OPT_musermsr = 2270,                       /* -musermsr */
  OPT_mvaes = 2271,                          /* -mvaes */
  OPT_mveclibabi_ = 2272,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2273,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2274,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2275,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2276,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2277,                      /* -mwbnoinvd */
  OPT_mwidekl = 2278,                        /* -mwidekl */
  OPT_mwin32 = 2279,                         /* -mwin32 */
  OPT_mwindows = 2280,                       /* -mwindows */
  OPT_mx32 = 2281,                           /* -mx32 */
  OPT_mxop = 2282,                           /* -mxop */
  OPT_mxsave = 2283,                         /* -mxsave */
  OPT_mxsavec = 2284,                        /* -mxsavec */
  OPT_mxsaveopt = 2285,                      /* -mxsaveopt */
  OPT_mxsaves = 2286,                        /* -mxsaves */
  OPT_n = 2287,                              /* -n */
  OPT_name_sort = 2288,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2289,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2290,              /* -no-integrated-cpp */
  OPT_no_pie = 2291,                         /* -no-pie */
  OPT_no_pthread = 2292,                     /* -no-pthread */
  OPT_nocpp = 2293,                          /* -nocpp */
  OPT_nodefaultlibs = 2294,                  /* -nodefaultlibs */
  OPT_nolibc = 2295,                         /* -nolibc */
  OPT_nomain = 2296,                         /* -nomain */
  OPT_nophoboslib = 2297,                    /* -nophoboslib */
  OPT_nostartfiles = 2298,                   /* -nostartfiles */
  OPT_nostdinc = 2299,                       /* -nostdinc */
  OPT_nostdinc__ = 2300,                     /* -nostdinc++ */
  OPT_nostdlib = 2301,                       /* -nostdlib */
  OPT_nostdlib__ = 2302,                     /* -nostdlib++ */
  OPT_o = 2303,                              /* -o */
  OPT_objects = 2304,                        /* -objects */
  OPT_p = 2305,                              /* -p */
  OPT_pass_exit_codes = 2306,                /* -pass-exit-codes */
  /* OPT_pedantic = 2307, */                 /* -pedantic */
  OPT_pedantic_errors = 2308,                /* -pedantic-errors */
  OPT_pg = 2309,                             /* -pg */
  OPT_pie = 2310,                            /* -pie */
  OPT_pipe = 2311,                           /* -pipe */
  OPT_posix = 2312,                          /* -posix */
  OPT_preprocess = 2313,                     /* -preprocess */
  OPT_print_file_name_ = 2314,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2315,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2316,          /* -print-multi-directory */
  OPT_print_multi_lib = 2317,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2318,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2319,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2320,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2321,               /* -print-prog-name= */
  OPT_print_search_dirs = 2322,              /* -print-search-dirs */
  OPT_print_sysroot = 2323,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2324,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2325,                    /* -print-value */
  OPT_pthread = 2326,                        /* -pthread */
  OPT_quiet = 2327,                          /* -quiet */
  OPT_r = 2328,                              /* -r */
  OPT_remap = 2329,                          /* -remap */
  OPT_reverse_sort = 2330,                   /* -reverse-sort */
  OPT_s = 2331,                              /* -s */
  OPT_save_temps = 2332,                     /* -save-temps */
  OPT_save_temps_ = 2333,                    /* -save-temps= */
  OPT_shared = 2334,                         /* -shared */
  OPT_shared_libgcc = 2335,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2336,               /* -shared-libphobos */
  OPT_size_sort = 2337,                      /* -size-sort */
  /* OPT_specs = 2338, */                    /* -specs */
  OPT_specs_ = 2339,                         /* -specs= */
  OPT_static = 2340,                         /* -static */
  OPT_static_libasan = 2341,                 /* -static-libasan */
  OPT_static_libgcc = 2342,                  /* -static-libgcc */
  OPT_static_libgcobol = 2343,               /* -static-libgcobol */
  OPT_static_libgfortran = 2344,             /* -static-libgfortran */
  OPT_static_libgm2 = 2345,                  /* -static-libgm2 */
  OPT_static_libgo = 2346,                   /* -static-libgo */
  OPT_static_libhwasan = 2347,               /* -static-libhwasan */
  OPT_static_liblsan = 2348,                 /* -static-liblsan */
  OPT_static_libmpx = 2349,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2350,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2351,               /* -static-libphobos */
  OPT_static_libquadmath = 2352,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2353,               /* -static-libstdc++ */
  OPT_static_libtsan = 2354,                 /* -static-libtsan */
  OPT_static_libubsan = 2355,                /* -static-libubsan */
  OPT_static_pie = 2356,                     /* -static-pie */
  /* OPT_std_c__03 = 2357, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2358, */                /* -std=c++0x */
  OPT_std_c__11 = 2359,                      /* -std=c++11 */
  OPT_std_c__14 = 2360,                      /* -std=c++14 */
  OPT_std_c__17 = 2361,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2362, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2363, */                /* -std=c++1z */
  OPT_std_c__20 = 2364,                      /* -std=c++20 */
  OPT_std_c__23 = 2365,                      /* -std=c++23 */
  OPT_std_c__26 = 2366,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2367, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2368, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2369, */                /* -std=c++2c */
  OPT_std_c__98 = 2370,                      /* -std=c++98 */
  OPT_std_c11 = 2371,                        /* -std=c11 */
  OPT_std_c17 = 2372,                        /* -std=c17 */
  /* OPT_std_c18 = 2373, */                  /* -std=c18 */
  /* OPT_std_c1x = 2374, */                  /* -std=c1x */
  OPT_std_c23 = 2375,                        /* -std=c23 */
  /* OPT_std_c2x = 2376, */                  /* -std=c2x */
  OPT_std_c2y = 2377,                        /* -std=c2y */
  /* OPT_std_c89 = 2378, */                  /* -std=c89 */
  OPT_std_c90 = 2379,                        /* -std=c90 */
  OPT_std_c99 = 2380,                        /* -std=c99 */
  /* OPT_std_c9x = 2381, */                  /* -std=c9x */
  OPT_std_f2003 = 2382,                      /* -std=f2003 */
  OPT_std_f2008 = 2383,                      /* -std=f2008 */
  OPT_std_f2008ts = 2384,                    /* -std=f2008ts */
  OPT_std_f2018 = 2385,                      /* -std=f2018 */
  OPT_std_f2023 = 2386,                      /* -std=f2023 */
  OPT_std_f202y = 2387,                      /* -std=f202y */
  OPT_std_f95 = 2388,                        /* -std=f95 */
  OPT_std_gnu = 2389,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2390, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2391, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2392,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2393,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2394,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2395, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2396, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2397,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2398,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2399,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2400, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2401, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2402, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2403,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2404,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2405,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2406, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2407, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2408,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2409, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2410,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2411, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2412,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2413,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2414, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2415, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2416,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2417, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2418, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2419, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2420, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2421, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2422, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2423,                     /* -std=legacy */
  OPT_stdlib_ = 2424,                        /* -stdlib= */
  OPT_symbol_ = 2425,                        /* -symbol= */
  OPT_symbolic = 2426,                       /* -symbolic */
  OPT_t = 2427,                              /* -t */
  OPT_time = 2428,                           /* -time */
  OPT_time_ = 2429,                          /* -time= */
  OPT_traditional = 2430,                    /* -traditional */
  OPT_traditional_cpp = 2431,                /* -traditional-cpp */
  OPT_tree_stats = 2432,                     /* -tree-stats */
  OPT_trigraphs = 2433,                      /* -trigraphs */
  OPT_truncate = 2434,                       /* -truncate */
  OPT_type_stats = 2435,                     /* -type-stats */
  OPT_u = 2436,                              /* -u */
  OPT_undef = 2437,                          /* -undef */
  OPT_v = 2438,                              /* -v */
  OPT_version = 2439,                        /* -version */
  OPT_w = 2440,                              /* -w */
  OPT_wrapper = 2441,                        /* -wrapper */
  OPT_x = 2442,                              /* -x */
  OPT_z = 2443,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
