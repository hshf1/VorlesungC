...
<details>
 ...
 {<br />
   ...
   // Zeigen Sie auf vorhandene Attribute, um die zugehörigen Beschreibungen anzuzeigen.<br />
   // Weitere Informationen finden Sie unter https://go.microsoft.com/fwlink/?linkid=830387<br />
   "version": "0.2.0",<br />
   "configurations": [<br />
       {<br />
           "name": "gcc - Aktive Datei erstellen und debuggen",<br />
           "type": "lldb",<br />
           "request": "launch",<br />
           "program": "${fileDirname}/${fileBasenameNoExtension}",<br />
           "args": [],<br />
           ...
           "MIMode": "lldb",<br />
           "preLaunchTask": "C/C++: gcc Aktive Datei kompilieren"<br />
       }<br />
   ]<br />
}<br />
  ```
