#####################################
#    VSCode Fehleranalyse für Linux #
...
#
# curl -sL https://raw.githubusercontent.com/hshf1/VorlesungC/main/VSCode/Quellcodes/Linux/Fehleranalyse.sh | bash 
...
if [ -e "$file" ]; then
    launchinfo="launch.json: $file wurde gefunden."
else
    launchinfo="launch.json: $file konnte nicht gefunden werden! (Fehlercode: 0005)"
fi
...
echo -e "------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------
Logfile zur Fehleranalyse von VSCode für Linux am $dateinfo um $timeinfo.
